...
class ChatService {
    ...
    createNewChat() {
        ...
        const newChat = { id, title, chatlog, agents: [], flow: { steps: [], connections: [] } };
    ...
    loadChats() {
        ...
        if (storedChats) {
            ...
            this.chats = parsed.map(chatData => {
                ...
                return { id: chatData.id, title: chatData.title, chatlog, agents: chatData.agents || [], flow: chatData.flow || { steps: [], connections: [] } };
            });
        } else {
